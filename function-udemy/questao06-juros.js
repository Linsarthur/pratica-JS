...
function jurosSimples(CI, TJ, TA) {
  ...
  console.log(
    `Os juros acumulados em ${TA} meses foram de: ${calculoDosJuros}`
  );
...
function jurosCompostos(CI, TJ, TA) {
  ...
  console.log(
    `Os juros acumulados em ${TA} meses com um investimento inicial de R$${CI} foram de R$${valorSemCI.toFixed(
      2
    )}`
  );
  return montante;
